...
class FakeFrame:
    ...
    def set_text(self, col, field_idx, text): self.text_calls.append((col, field_idx, text))
    def set_color(self, col, obj_idx, color): self.color_calls.append((col, obj_idx, color))
    def set_value(self, col, field_idx, value): self.value_calls.append((col, field_idx, value))
